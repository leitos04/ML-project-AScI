...
hdf5_path = '/scratch/phys/project/sin/STM_Band_DB/spm_data/stm_afm_esmap_5.3_above/data/data.hdf5'                       # Path to HDF5 database where data is read from
...
def apply_preprocessing(batch):
    ...
    X, Y, atoms = batch
    atoms = [atom[:, [0, 1, 2, 4, 3]] for atom in atoms] # switch Z and q columns
